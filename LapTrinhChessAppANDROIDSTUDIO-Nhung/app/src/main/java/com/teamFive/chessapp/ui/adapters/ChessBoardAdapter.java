...
public class ChessBoardAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // --- Tái sử dụng hoặc tạo mới CellView ---
        final CellView cell;
        ...
        } else if (position == checkKingIndex) {
            bgColor = COLOR_CHECK;
        } else {
        ...
        cell.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                handleCellClick(position, row, col);
            }
        });
    ...
    // ================================================================
    //  CellView — View tự tạo bằng code, không inflate XML
    // ================================================================
    static class CellView extends FrameLayout {
        ...
        CellView(Context context) {
            ...
            // TextView hiển thị quân cờ Unicode
            ...
            // View overlay highlight nước đi
